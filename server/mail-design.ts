    ...
    return {
        ...frame({
            ...
            preheader: detailed
                ...
                : "Your private weekly letter is ready to read.",
            origin,
            ...
            sections: detailed
                ...
                : [
                      {
                          heading: "Your weekly letter is ready",
                          text: "A look at the week's recorded work, anything waiting for your attention, and the plan ahead. Sign in to read your family's private letter.",
                      },
                  ],
            action: { label: "Open this week's letter", path: `/letters?week=${letter.to}` },
            unsubscribe,
