...
export const rowGame: ActionGame<RowState> = {
    ...
    hint: "Drag back through the water to row and forward again to get ready, or hold space for a stroke and let go; a press that first drags forward, or the left arrow, backs water",
    controls: {},
    start,
    step,
    frame,
